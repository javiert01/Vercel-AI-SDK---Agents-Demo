...
export async function POST(req: NextRequest) {
  ...
  const result = await streamText({
    ...
    prompt,
    system:
      "You are a helpful assistant that can perform basic arithmetic operations. Encourage the user to keep the conversation going by asking follow-up questions.",
    tools: {
